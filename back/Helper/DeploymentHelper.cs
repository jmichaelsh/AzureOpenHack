...
namespace Backend_API_Minecraft.Helper
{
    /// <summary>
    ...
    {
        string subscriptionId = "b9049f27-f15e-41ae-8853-8bc37dce9630";
        string clientId = "";
        string clientSecret = "";
        string resourceGroupName = "desafio2";
        string resourceGroupLocation = ""; // must be specified for creating a new resource group
        string pathToTemplateFile = "./template_aks_miner.json";
        string pathToParameterFile = "./parameter.json";
        string tenantId = "";
